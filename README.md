...
```mermaid
graph TD
    A[Raw Data Sources: APIs, Scrapers, DBs] -->|ETL: Python & Airflow| B[(Staging / Raw DB)]
    B -->|Transform: dbt & SQL| C[(Data Warehouse)]
    C -->|Load / Visualize| D[Tableau Dashboards]
    
    C -->|Context Feeding| E[AI Agentic Crews: crewAI]
    E -->|Automated Reports & Insights| F[Report Outlets / custom UI]
    
    G[User Interaction: Voice/Text] -->|Local STT: Whisper| H[Local LLM: Ollama/FastAPI]
    H -->|Local TTS: Piper| I[Response Output]
